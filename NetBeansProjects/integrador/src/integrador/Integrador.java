...
public class Integrador {
    ...
    public static void main(String[] args) {
        ...
        String[] nombresArribaDelPromedio = escuela.obtenerNombresArribaDelPromedio();
        System.out.println("Alumnos con nota arriba del promedio: " + Arrays.toString(nombresArribaDelPromedio));

        escuela.mostrarArribaDelPromedio();
    }
}
